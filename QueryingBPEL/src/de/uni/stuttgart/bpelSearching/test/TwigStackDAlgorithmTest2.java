...
public class TwigStackDAlgorithmTest2 {
	...
	private static ProcessGraph processFlowGraph1;
	...
	private static ProcessGraph processFlowGraph2;
	...
	public static void setUp() {
		...
		// process graph 1
		processFlowGraph1 = new ProcessGraph("processDAG1", "namespace1", "id1",
				processDAG1);
...
//		query1.addEdge(query1M, query1C);
		...
		// process graph 2
		processFlowGraph2 = new ProcessGraph("processDAG2", "namespace2", "id2",
				processDAG2);		
		// query 2
		...
		query21FirstName = new ActivityNode("query21FirstName", "first name", 1);
		query21FamilyName = new ActivityNode("query21FamilyName", "family name", 1);
