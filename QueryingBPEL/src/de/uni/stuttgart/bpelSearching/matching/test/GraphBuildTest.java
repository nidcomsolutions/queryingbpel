...
/**
 * GraphBuildTest de.uni.stuttgart.bpelSearching.matching.test the building of process graphs of the given bpel process
 * in the database.
 * 
...
public class GraphBuildTest {
	 ...
	 * database. This de.uni.stuttgart.bpelSearching.matching.test contains loading the bpel processes from the
...
//		 create reference string output for regression de.uni.stuttgart.bpelSearching.matching.test
...
//		for (int i = 0; i < processes.size(); i++) {
//			Process process = processes.get(i);
//			ProcessFlowGraphFactory2 graphFactory = new StandardProcessFlowGraphFactory(
//					process);
//			ProcessFlowGraph graph = graphFactory
//					.createProcessFlowGraph(process);
//			resultString += PrintClass.printProcessFlowGraphString(graph);
