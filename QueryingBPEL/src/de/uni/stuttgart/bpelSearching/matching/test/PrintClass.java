...
/*
	public static String printLatticeNodeString(
		...
		Map<String, List<ProcessFlowGraph>> graphMap = node
				.getContainedGraphsMap();

		resultString += "graphMap size: " + graphMap.size() + "\n";

		for (List<ProcessFlowGraph> tempList : graphMap.values()) {
...
*/
	/**
	 * Print all vertices (their activityIDs) of the given ProcessFlowGraph with
	 * targets.
	 */
	...
	public static String printProcessFlowGraphString(
			ProcessFlowGraph processFlowGraph) {
		...
		resultString += "ProcessName: " + processFlowGraph.getProcessName()
				+ "\n";
		Set<ActivityNode> vertexSet = processFlowGraph.getProcessGraph()
				.vertexSet();
		for (ActivityNode vertex : vertexSet) {
			Set<DefaultEdge> edgeSet = processFlowGraph.getProcessGraph()
			...
			for (DefaultEdge edge : edgeSet) {
				ActivityNode targetNode = processFlowGraph.getProcessGraph()
						.getEdgeTarget(edge);
