...
/**
 * The StructuredProcessGraphFactory1 class is a creator for ProcessGraph
 * objects from a loaded BPEL process from the database. This class is
 * responsible for the correct mapping of a BPEL process to a ProcessGraph.
...
public class StructuredProcessGraphFactory1 extends ProcessGraphFactory1 {
	
	/**
	 * Initialize the StructuredProcessGraphFactory1 with the given BPEL
	 * process.
	 * 
	 * @param process
	 ...
	 *            be generated.
	 */
	public StructuredProcessGraphFactory1(Process process) {
		super(process);
	}
