...
public class StructuredProcessFlowGraphFactory extends ProcessFlowGraphFactory {
	/**
	 ...
	 *            be generated.
	 */
	public StructuredProcessFlowGraphFactory(Process process) {
		super(process);
	}
	...
	private ActivityNode createStructureHelperNode(
		...
		ActivityNode node = new StructuredActivityNode(IdentifierCacheHandler.getID(structureHelper).toString(), 
				structureHelperName, structureHelperType, IdentifierCacheHandler.getID(structureHelper.eContainer()).toString(), isStart);
