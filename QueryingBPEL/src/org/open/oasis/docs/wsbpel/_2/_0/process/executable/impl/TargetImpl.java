 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.TargetImpl#getLinkName <em>Link Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TargetImpl extends ExtensibleElementsImpl implements Target {
	...
	protected EClass eStaticClass() {
		return ExecutablePackage.Literals.TARGET;
	}
	...
	public void setLinkName(String newLinkName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutablePackage.TARGET__LINK_NAME, oldLinkName, linkName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutablePackage.TARGET__LINK_NAME:
				return getLinkName();
		}
