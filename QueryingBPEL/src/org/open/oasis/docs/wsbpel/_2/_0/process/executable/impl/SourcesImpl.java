 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.SourcesImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourcesImpl extends ExtensibleElementsImpl implements Sources {
	...
	protected EClass eStaticClass() {
		return ExecutablePackage.Literals.SOURCES;
	}
	...
	public EList<Source> getSource() {
		if (source == null) {
			source = new EObjectContainmentEList<Source>(Source.class, this, ExecutablePackage.SOURCES__SOURCE);
		}
		return source;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExecutablePackage.SOURCES__SOURCE:
