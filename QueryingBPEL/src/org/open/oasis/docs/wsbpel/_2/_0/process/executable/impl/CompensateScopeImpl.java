 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.CompensateScopeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompensateScopeImpl extends ActivityImpl implements CompensateScope {
	...
	protected EClass eStaticClass() {
		return ExecutablePackage.Literals.COMPENSATE_SCOPE;
	}
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutablePackage.COMPENSATE_SCOPE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutablePackage.COMPENSATE_SCOPE__TARGET:
				return getTarget();
		}
