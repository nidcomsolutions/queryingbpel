 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.ToPartsImpl#getToPart <em>To Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToPartsImpl extends ExtensibleElementsImpl implements ToParts {
	...
	protected EClass eStaticClass() {
		return ExecutablePackage.Literals.TO_PARTS;
	}
	...
	public EList<ToPart> getToPart() {
		if (toPart == null) {
			toPart = new EObjectContainmentEList<ToPart>(ToPart.class, this, ExecutablePackage.TO_PARTS__TO_PART);
		}
		return toPart;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExecutablePackage.TO_PARTS__TO_PART:
