 ...
 * <ul>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.FromPartImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.open.oasis.docs.wsbpel._2._0.process.executable.impl.FromPartImpl#getToVariable <em>To Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromPartImpl extends ExtensibleElementsImpl implements FromPart {
	...
	protected EClass eStaticClass() {
		return ExecutablePackage.Literals.FROM_PART;
	}
	...
	public void setPart(String newPart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutablePackage.FROM_PART__PART, oldPart, part));
	}
	...
	public void setToVariable(String newToVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutablePackage.FROM_PART__TO_VARIABLE, oldToVariable, toVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutablePackage.FROM_PART__PART:
				return getPart();
			case ExecutablePackage.FROM_PART__TO_VARIABLE:
