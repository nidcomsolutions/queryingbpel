...
//		query2-v1
		...
		// query2-v2
//		query2A = new ActivityNode("q2A", "A", ActivityType.INVOKE);
//		query2B1 = new ActivityNode("q2B1", "B", ActivityType.INVOKE);
//		query2B2 = new ActivityNode("q2B2", "B", ActivityType.INVOKE);
//		query2C1 = new ActivityNode("q2C1", "C", ActivityType.INVOKE);
//		query2C2 = new ActivityNode("q2C2", "C", ActivityType.INVOKE);
//		
//		query2.addVertex(query2A);
//		query2.addVertex(query2B1);
//		query2.addVertex(query2B2);
//		query2.addVertex(query2C1);
//		query2.addVertex(query2C2);
//		
//		query2.addEdge(query2A, query2B1);
//		query2.addEdge(query2B1, query2C1);
//		query2.addEdge(query2B1, query2B2);
//		query2.addEdge(query2A, query2C2);
		
		processGraph2 = new ProcessFlowGraph("processTwigStackTest", "www", "100", process2);
