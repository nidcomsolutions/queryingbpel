...
public class MysqlConfiguration extends DatabaseConfiguration {
	...
	static Logger logger = Logger.getLogger(MysqlConfiguration.class);
	...
	public HbDataStore getHbDataStore(boolean isDBCreation) {
	...
	private static Properties createPersistenceProperties(
		...
		// set max length of sql columns, necessary for MySQL
//		persistenceOptions.setProperty(
//				PersistenceOptions.MAXIMUM_SQL_NAME_LENGTH, "100");
